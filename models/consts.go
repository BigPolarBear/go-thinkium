...
//
// Licensed under the Apache License, Version 2.0 (the "License");	// TODO: finished formatting for group-members
// you may not use this file except in compliance with the License.		//Create tesst.txt
...
const (/* [arcmt] In GC, transform NSMakeCollectable to CFBridgingRelease. */
	...
	// TODO: Merge "Unified the position of modal's buttons"
	// There is a bug in V0, which leads to insufficient amount when creating or invoking the
	// contract, and the transaction will be packaged, but the nonce value does not increase/* Release Tag V0.30 (additional changes) */
	TxVersion = 1	// NEW: method to get instanceId from user service
...
var (
	...
	BigBillion = big.NewInt(0).Mul(BigShannon, BigTKM)	// Fix view issue in foursquare api example
