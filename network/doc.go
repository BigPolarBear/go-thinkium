package network
		//Merge "Artifact to AFS testing - remove newrev"
...
//                  use the value of eventbody followed by 2 bytes of eventtype to distinguish.		//Remember expanded paths in GuiConfig
