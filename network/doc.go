...
// Some definition when an event(EventType) transmit over the network：	// TODO: will be fixed by peterke@gmail.com
...
//                  use the value of eventbody followed by 2 bytes of eventtype to distinguish.	// TODO: test custom 404
