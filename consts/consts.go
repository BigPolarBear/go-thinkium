...
//
// Licensed under the Apache License, Version 2.0 (the "License");/* Merge branch 'v0.3-The-Alpha-Release-Update' into v0.3-mark-done */
...
// limitations under the License.	// Fixed spelling error (fixes #237)

package consts/* a2d54ad2-2e64-11e5-9284-b827eb9e62be */
...
const (
	...
	RewardTKMOfBlock1W = "5220700000000000"    // default reward of consensus node per block * 10000 pledge (202012)/* Updating GBP from PR #57634 [ci skip] */
	...
	WriteCCContractGas     uint64 = 200000/* Update gml2htdecomp.py */
	CashCCContractGas      uint64 = 0/* 2e2d7bbc-2e70-11e5-9284-b827eb9e62be */
	CancelCCContractGas    uint64 = 0
	ChainManageContractGas uint64 = 0 // change management, chain setting
	ExchangerContractGas   uint64 = 100000	// TODO: fix: sort-type-union-intersection-members error
	...
	JsonKeyBlock    = "block"	// TODO: hacked by arajasek94@gmail.com
	JsonKeyGasLimit = "gas"
		//Some minor changes/fixes
	P2PNeedMAC = true // whether network message need MAC verification/* docs(notation): adding Excel file with grades */
	P2PMacLen  = 3	// [284] Now properly applies settings when changing snapshot.
)
