...
package rpcserver	// TODO: will be fixed by sjors@sprovoost.nl
...
var _ = proto.Marshal/* Updated Release log */
var _ = fmt.Errorf
var _ = math.Inf
...
// proto package needs to be updated./* Java Task : MainGeneratorAtomicWith2SIn1AIn */
const _ = proto.ProtoPackageIsVersion3 // please upgrade the proto package

type RpcChainInfoReq struct {
	Chainid              []uint32 `protobuf:"varint,1,rep,packed,name=chainid,proto3" json:"chainid,omitempty"`	// TODO: will be fixed by admin@multicoin.co
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`		//Update PortAIO.csproj
}/* Release 0.4.26 */

func (m *RpcChainInfoReq) Reset()         { *m = RpcChainInfoReq{} }
func (m *RpcChainInfoReq) String() string { return proto.CompactTextString(m) }
func (*RpcChainInfoReq) ProtoMessage()    {}/* Added Travic-ci build indicator. */
...
func (m *RpcChainInfoReq) XXX_DiscardUnknown() {
	xxx_messageInfo_RpcChainInfoReq.DiscardUnknown(m)	// <root level="debug">
}
...
type RpcAddress struct {
	...
	XXX_NoUnkeyedLiteral struct{} `json:"-"`/* 72fWoZjIDejdwMrGkImeJjQbjujLczac */
	XXX_unrecognized     []byte   `json:"-"`
...
func (m *RpcAddress) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RpcAddress.Unmarshal(m, b)/* 3.9.1 Release */
}
...
}	// TODO: [Tools] Add listroles & black formatting
...
func (m *RpcAddress) XXX_DiscardUnknown() {	// TODO: Cathscop import
	xxx_messageInfo_RpcAddress.DiscardUnknown(m)
}

var xxx_messageInfo_RpcAddress proto.InternalMessageInfo		//oauth service provider demo
