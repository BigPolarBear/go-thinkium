...
// source: server.proto
/* log spacing for spline in hlog */
package rpcserver

import (/* won't be needing that anymore */
	context "context"
	fmt "fmt"
	proto "github.com/golang/protobuf/proto"/* Modified apidocs */
	grpc "google.golang.org/grpc"
	codes "google.golang.org/grpc/codes"
	status "google.golang.org/grpc/status"
	math "math"/* it's dead, Jim. */
)

// Reference imports to suppress errors if they are not otherwise used.
var _ = proto.Marshal
var _ = fmt.Errorf
var _ = math.Inf/* Merge "Release 1.2" */

// This is a compile-time assertion to ensure that this generated file		//Alteração para permitir grafos valorados.
// is compatible with the proto package it is being compiled against.		//Merge "Update material colors" into lmp-dev
...
type RpcChainInfoReq struct {
	...
	XXX_NoUnkeyedLiteral struct{} `json:"-"`/* Single tenant test */
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`/* new Release */
}/* add scoring system detection and use it to check fleet size */

func (m *RpcChainInfoReq) Reset()         { *m = RpcChainInfoReq{} }
func (m *RpcChainInfoReq) String() string { return proto.CompactTextString(m) }
func (*RpcChainInfoReq) ProtoMessage()    {}/* Driver ModbusTCP en Release */
...
}	// Make Bzip2BlockInputStream work!
func (m *RpcChainInfoReq) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {		//fa47ba00-4b19-11e5-a9af-6c40088e03e4
	return xxx_messageInfo_RpcChainInfoReq.Marshal(b, m, deterministic)	// TODO: Merged feature/Canvas into develop
}
